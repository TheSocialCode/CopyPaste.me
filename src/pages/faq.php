    ...
    <div class="main-information">
        <div class="main-interface-information">
            ...
            <div class="main-interface-information-section left">
                ...
                <p class="main-interface-information-section-body">
                    Yes, to learn how I can improve this website I use Matomo, a privacy friendly paid alternative to "free" services like Google Analytics for which you basically pay by letting them collect data on you so they can sell that data to third parties. Instead, Matomo offers 100% ownership of the data, meaning they are not allowed to do anything with you data. Next to this I've written some very basis stats specifically for this tool, just enough to monitor 'how' <a href="/" class="highlighted">CopyPaste.me</a> is used – not who uses it, when, where or for what.
                </p>
                <p class="main-interface-information-section-body">
