    ...
    <div class="main-information">
        <div class="main-interface-information">
            ...
            <div class="main-interface-information-section left">
                ...
                <p class="main-interface-information-section-body">
                    Yes, a very simple version, just enough to monitor 'how' <a href="/" class="highlighted">CopyPaste.me</a> is used – not who uses it, when, where or for what. I've written some basic analytics myself instead of using "free" tools like Google Analytics that scrape the hell out of every user and could provide me with way more information than I'll ever need (don't  get me wrong, I love stats, I just think they don't belong here in order to safeguard your privacy).
                </p>
                <p class="main-interface-information-section-body">
